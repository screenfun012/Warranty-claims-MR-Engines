 ...
 * Includes planner-specific roles: PLANNER_VIEWER (samo pregled), PLANNER_OPERATOR (pravi/dodaje/menja, briše samo svoje)
 */
...
export const PERMISSIONS = {
  ...
  // Export planner
  EXPORT_PLANNER_READ: "export_planner.read",
  EXPORT_PLANNER_CREATE: "export_planner.create",
  EXPORT_PLANNER_EDIT: "export_planner.edit",
  EXPORT_PLANNER_DELETE_ANY: "export_planner.delete_any",
} as const;
...
export const ROLE_HIERARCHY: Role[] = [
  ROLES.VIEWER,
  ROLES.PLANNER_VIEWER,
  ROLES.PLANNER_OPERATOR,
  ROLES.OPERATOR,
  ROLES.ADMIN,
  ROLES.SUPER_ADMIN,
];
